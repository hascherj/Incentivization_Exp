...
jsPsych.plugins['rating-scale'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // add submit button
    html += '<button id="jspsych-image-slider-response-next" class="jspsych-btn" '+ (trial.require_movement ? "disabled" : "") + '>'+trial.button_label_continue+'</button>';
