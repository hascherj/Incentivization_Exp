...
jsPsych.plugins["binary-food"] = (function () {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      healthy_side: {
        ...
        pretty_name: 'donate side',
        default: undefined,
        description: 'if the healthy yes side is on the left or right'
      }
    }
  };
  ...
  plugin.trial = function (display_element, trial) {
    ...
    var display_stage = function () {
      ...
      if (healthy_side == 1 && trial.stimulus.stimulus1_food_type == "healthy"){
        ...
        on_Screen += '</div>';
        on_Screen += '</div>';
      } else if (healthy_side == 2 && trial.stimulus.stimulus1_food_type == "healthy") {
        on_Screen += '<div class="container-multi-choice">';
        on_Screen += '<div class="container-multi-choice-column" id= "multiattribute-choices-stimulus-left">';
        on_Screen += `<div id="multiattribute-choices-stimulus-left" ><img height="auto" width="350px" src="${trial.stimulus.stimulus2}"/></div>`;
        on_Screen += '</div>';
        on_Screen += '<div class="container-multi-choice-column" id= "multiattribute-choices-stimulus-right">';
        on_Screen += `<div id="multiattribute-choices-stimulus-right " ><img height="auto" width="350px" src="${trial.stimulus.stimulus1}"/></div>`;
        on_Screen += '</div>';
        on_Screen += '</div>';
      }

      if (healthy_side == 1 && trial.stimulus.stimulus1_food_type == "unhealthy"){
        on_Screen += '<div class="container-multi-choice">';
        on_Screen += '<div class="container-multi-choice-column" id= "multiattribute-choices-stimulus-left">';
        on_Screen += `<div id="multiattribute-choices-stimulus-left " ><img height="auto" width="350px" src="${trial.stimulus.stimulus2}"/></div>`;
        on_Screen += '</div>';
        ...
        on_Screen += '</div>';
        on_Screen += '</div>';
      } else if (healthy_side == 2 && trial.stimulus.stimulus1_food_type == "unhealthy") {
        on_Screen += '<div class="container-multi-choice">';
        on_Screen += '<div class="container-multi-choice-column" id= "multiattribute-choices-stimulus-left">';
        on_Screen += `<div id="multiattribute-choices-stimulus-left" ><img height="auto" width="350px" src="${trial.stimulus.stimulus1}"/></div>`;
        on_Screen += '</div>';
